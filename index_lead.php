<?php
  ...
  $countyList = [];
  $findCountyStmt = $pdo->prepare("SELECT section_id, section_name, population, flags FROM Section WHERE is_county != 0 AND is_city = 0 AND active=1");
  ...
  $cityList = [];
  $findCityStmt = $pdo->prepare("SELECT section_id, section_name, population, flags, is_city FROM Section WHERE is_county != 0 AND active=1 ORDER BY is_county ASC, is_city ASC, section_name ASC");
